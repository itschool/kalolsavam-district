...
class CI_Upload {
	...
	function do_upload($field = 'userfile')
	{
		...
		//echo "<br />-----here-->".var_dump($_FILES[$field]);
	...
	function data()
	{
		return array (
						...
						//'image_type'		=> end(explode('.',$this->file_ext),
	...
	function set_image_properties($path = '')
	{
		...
		if (function_exists('getimagesize'))
		{
			...
			{	
				...
				//echo "<br />imagetype---".$this->image_type;
	...
	function is_image()
	{
		...
		//echo "<br /><br />type2----->".$this->file_type."<br />";
		$img_mimes = array(
							'image/gif',
							'image/jpeg',
							'image/png',
