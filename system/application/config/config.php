...
$config['base_url']		=   $url."/kalolsavam_district/";
$config['base_path']	=	constant("DOCUMENT_ROOT").'/'; 


if(!defined('_DOCUMENT_ROOT')) define('_DOCUMENT_ROOT', $config['base_path']);
if(!defined('_UPDALOD_FOLDER')) define('_UPDALOD_FOLDER', _DOCUMENT_ROOT.'uploads/');
if(!defined('_PROFILE_FOLDER')) define('_PROFILE_FOLDER', _UPDALOD_FOLDER.'profile/');
if(!defined('_CLIENT_FOLDER')) define('_CLIENT_FOLDER', _UPDALOD_FOLDER.'clients/');
if(!defined('_UPDALOD_URL')) define('_UPDALOD_URL', $config['base_url'].'uploads/');
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
