	...
	<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
	  <tr>
	   ...
	   <tr>
		...
		<td align="left" width="40%" class="table_row_first"><?php display_kalolsavam_logo ('sub_dist', @$selected_kalolsavam[0]['logo_name']);?></td>
	  ...
	  <tr>
		...
		<td align="left" class="table_row_first">
			<?php echo @$selected_kalolsavam[0]['sub_dist_kalolsavam_name'];?>
		<td align="left" colspan="2" class="table_row_first">&nbsp;</td>
	  </tr>
	  <tr>
	  ...
	  <tr>
		...
		<td align="left" class="table_row_first">
			...
			<?php echo form_input("txtStartDate", @$start_date, 'class="input_box" id="txtStartDate"  onfocus="javascript:displayCalendar($(\'txtStartDate\'),\'yyyy-mm-dd\',this);" readonly="readonly" ');?>
	  ...
	  <tr>
		...
		<td align="left" class="table_row_first">
			...
			<?php echo form_input("txtEndDate", @$end_date, 'class="input_box" id="txtEndDate"  readonly="readonly"');?>
	  ...
	  <tr>
		<td align="center" colspan="2">
			<?php echo (count(@$selected_kalolsavam) > 0 ) ? form_button('update_kalolsavam', 'Update', 'id="update_kalolsavam" 
							onClick="javascript:fncUpdateKalolsavam(\'sub_dist\',\''.$selected_kalolsavam[0]['sub_dist_kalolsavam_id'].'\')"').'&nbsp;&nbsp;'.form_button('Cancel', 'Cancel', 'onClick="javascript:fncCancelKalolsavam()"'): form_button('save_kalolsavam', 'Save', 'id="save_kalolsavam" onClick="javascript:fncSaveKalolsavam();"');?>
		</td>
	  </tr>
	</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  <tr>
    <th width="5%">Sl No.</th>
	<th width="35%">Kalolsavam Name</th>
  ...
  ?>
  	<tr>
		...
		<td align="left" class="<?php echo $class_name;?>" ><?php echo $kalolsavam['sub_dist_kalolsavam_name'];?></td>
		...
		<td align="left" class="<?php echo $class_name;?>">
			...
			<a href="javascript:void(0)" onClick="javascript:fncEditKalolsavam('<?php echo $kalolsavam['sub_dist_kalolsavam_id']?>');return false;">
