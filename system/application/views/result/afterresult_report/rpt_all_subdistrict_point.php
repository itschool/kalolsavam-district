...
<table width="94%" height="62" border="0" cellpadding="0" cellspacing="0" align="center">
  <tr>
    <td align="center" height="30" valign="top"><strong class="style1">Grade-Point Report of all Sub Districts</strong></td>
  </tr>
</table>
...
<tr>
  ...
  <tr>
    ...
    <td class="style3" style='border: 0 0 0.5px 0.5px 0 #000000;  height:20px;'width="450" rowspan="2" align="left" >&nbsp;&nbsp;Subdistrict</td>
  ...
  <tr>
    ...
    <td class="style4" style='border: 0 0 0.5px 0.5px 0 #000000;  height:20px;'align="left" >&nbsp;&nbsp;<?php echo $data['sub_district_name']; ?></td>
    	<?php
		...
		for($h=0;$h<count($grade);$h++){
			if(($grade[$h]['sub_district_code']==$data['sub_district_code'])&&($grade[$h]['fest_id']==$data['fest_id'])){
