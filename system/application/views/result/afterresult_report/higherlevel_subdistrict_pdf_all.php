	 ...
	 <?php
		 ...
		 $prevfestid="";
  	 	for($j=0;$j<count($retvalue);$j++){
			$count++;
			if($prevfestid!=$retvalue[$j]['sub_district_code']){
                $prevfestid=$retvalue[$j]['sub_district_code'];
				if($j!=0){
				print("</table></page>");
...
<tr>  <td  align="center" height="30" valign="top" class="style1"><?php echo $retvalue[0]['rev_district_name']; ?> District</td>
        </tr>
        <tr>
            <td  align="center" height="30" valign="top" class="style1">Participants Eligible For Higher Level Competition from <?php echo $retvalue[$j]['sub_district_name']; ?></td></tr>
          </table>
...
<tr>
    ...
    <tr>
      ...
      <td align="left" style='border: 0 0 0.5px 0.5px 0 #000000;  height:20px;'><?php echo wordwrap($retvalue[$j]['school_code'].' - '.$retvalue[$j]['school_name'],30,'<br>'); ?></td>
