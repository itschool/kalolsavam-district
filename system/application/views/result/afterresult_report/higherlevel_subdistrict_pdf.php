...
<tr>  <td  align="center" height="30" valign="top" class="style1"><?php echo $retvalue[0]['sub_district_name']; ?> Sub DIstrict</td>
        </tr>
        <tr>
            <td  align="center" height="30" valign="top" class="style1">Participants Eligible For Higher Level Competition in <?php echo $retvalue[$j]['fest_name']; ?></td></tr>
          </table>
