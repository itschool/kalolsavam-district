...
<h3> Eligible Participants List</h3>
</div>
<br />

<?php echo form_open('report/prereportpdf/eligible_result', array('id' => 'higher_result','target'=>'_blank'));
echo blue_box_top();
...
<?php echo form_open('report/prereportpdf/schoolhigher_result', array('id' => 'school_result','target'=>'_blank'));
echo blue_box_top();
?>
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  <tr>
  ...
  <tr>
    ...
    <td align="left" width="55%" class="table_row_first"><a href="../prereportpdf/consolidated_resultall" target="_blank"><strong>Consolidated Report </strong></a></td>
