...
<table width="100%" border="0" align="center">
       ...
       <tr>
     		...
     		<td  class="style2" align="center"><b>  <?php echo $data['sub_district_code'];?>&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;<?php echo $data['sub_district_name'];?></b></td>
  		</tr>
	  	<?php
      	}
      	?>
...
<table width="93%" border="1" align="center" cellpadding="0" cellspacing="0">
	...
	$previous=$data['fest_name'];
	 ...
	 <tr>
        ...
        <td colspan="3" align="right" style=' height:20px;'>Total Point :&nbsp;</td>
...
<tr>
      ...
      <td width="200" align="left" style='border: 0 0 0.5px 0.5px 0 #000000;  height:20px;'>&nbsp;Name </td>
      <td width="150" align="left" style='border: 0 0 0.5px 0.5px 0 #000000;  height:20px;'>&nbsp;School </td>
    ...
    <tr>
        ...
        <td align="left" style='border: 0 0 0.5px 0.5px 0 #000000;  height:20px;'>&nbsp;<?php echo wordwrap($data['school_name'],25,'<br/>');?></td>
		...
		<?php
         ...
         <td align="center" style=' height:20px;'>&nbsp;</td>
        <td align="left" style='  height:20px;'>&nbsp;</td>
        <td colspan="3" align="right"   style='border: 0 0 0.5px 0.5px 0 #000000;  height:20px;'>Total Point :&nbsp;</td>
