...
<h3>Status Of Kalolsavam Itemwise</h3>
</div>
<br />
<?php echo form_open('report/afterresultreportpdf/status_of_kalolsvam', array('id' => 'formDWP', 'target'=>'_blank'));
echo blue_box_top();
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  ...
  <tr>
    ...
    <td align="left" width="55%" class="table_row_first">
      <label>
        <input type="submit" name="btnSubmit" id="btnSubmit" value="View Status">
        </label>       </td>
    <td width="18%">&nbsp;</td>
  </tr>
