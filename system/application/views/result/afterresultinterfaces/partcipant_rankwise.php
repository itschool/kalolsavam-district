...
<h3>Participant Wise :Rankwise  Result</h3>
</div>
<br />
<?php echo form_open('report/afterresultreportpdf/datewisepart', array('id' => 'formDWP', 'target'=>'_blank'));
echo blue_box_top();
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  ...
  <tr>
    ...
    <td align="left" width="55%" class="table_row_first"><?php echo form_dropdown("cmbFestType",$fest,'', 'class="input_box" id="cmbFestType" onchange="javascript:fetch_rankwise_participant_result(this.value)"');?></td>
    <td width="18%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
