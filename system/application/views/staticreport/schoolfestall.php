...
<page_footer>
	    ...
	    <table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
          ...
          <tr height="30">
            ...
            <td align="center" height="25" ><?php echo $school_details[$j]['fest_name']; ?></td>
            <td align="center" height="25" ><?php echo $school_details[$j]['school_code']; ?></td>
            <td align="left" height="25" ><?php echo $school_details[$j]['school_name']; ?></td>
          </tr>
          <?php
            }
        ?>
