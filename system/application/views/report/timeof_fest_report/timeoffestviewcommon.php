...
<br>
<?php echo form_open('', array('id' =>'common_report','target'=>'_blank'));
echo blue_box_top();
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  <tr>
    ...
    <th class="table_row_first" >Print&nbsp;&nbsp;<img src="<?php echo base_url(false).'images/print_icon.png';?>" title="print" class="window_print" 
  ...
  <tr>
    ...
    <th width="17%" >&nbsp;</th>
      ...
      ?>
  <tr>
    <td class="table_row_first">&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onClick="javascript:resultcommon('<?php echo $value['item_code'] ?>')">
    ...
    <td align="left" width="30%" class="table_row_first">
      ...
      <tr>
            ...
            <a href="javascript:void(0)" onClick="javascript:resultallcommon()">
            All Results</a></td>
