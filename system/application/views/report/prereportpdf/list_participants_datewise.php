...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <?php echo $partdata[$j]['item_code'];?>&nbsp;-&nbsp;<?php echo $partdata[$j]['item_name'].'  on  '.datetophpmodel($partdata[$j]['start_time']);?>&nbsp;&nbsp;</td>
    ...
    <tr>
        ...
        <td  class="ety"align="left" style=" border-bottom:1px #000000; border-right:0px #000000; padding:2px;"'><?php echo wordwrap($partdata[$j]['school_code'].' - '.$partdata[$j]['school_name'].'('.$partdata[$j]['sub_district_name'].')',45,'<br>');?></td>
    </tr>
    <?php 
    }
    ?>
