...
<page backtop="20mm" backbottom="20mm ">
	<page_header>
		...
		print("<table>");
		for($r=0;$r<$tdcount;$r++){
		print("<tr><td colspan=6 height=30>$tdcount</td></tr>");
		}
		print("</table>");
		}
		}
...
<tr bordercolor="#000000">
  ...
  <td width="16%" align="center" class="style2" style="border: 0 0px 1px 0 #000000;" >&nbsp;&nbsp;Date&nbsp;&nbsp;</td>
            ...
            <td align="center" height="20" class="style9" style="border: 0 0px 1px 0 #000000;" >&nbsp;&nbsp;<?php echo $fees_details[$i]['stage_name'].' - '.$fees_details[$i]['stage_desc']; ?> &nbsp;</td>
