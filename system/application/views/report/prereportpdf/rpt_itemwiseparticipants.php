...
<page backtop="30mm" backbottom="20mm ">
	<page_header>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
            <tr>
                <td colspan="2" class="style1" align="center">Itemwise participants list</td>
            </tr>
             <tr>
        <td class="tb" align="left">Item  :&nbsp;&nbsp;
        <?php echo $itemdet[0]['item_code'];?>&nbsp;-&nbsp;<?php echo $itemdet[0]['item_name'];?>&nbsp;&nbsp;</td>
        <td class="tb" align="left">&nbsp;&nbsp;Festival :<?php echo $festdet[0]['fest_name'];?></td>
  </tr>
        </table>
	</page_header>
<page_footer>
...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td class="ety"  align="center" style="border-top:1px #000000; border-right:1px #000000; padding:2px;"><?php echo $data['gender'];?></td>                  
        ...
        <td class="ety"  align="left" style="border-top:1px #000000; border-right:0px #000000; padding:2px;">&nbsp;&nbsp;<?php echo wordwrap($data['school_code'].' - '.$data['school_name'].' ('.$data['sub_district_code'].' - '.$data['sub_district_name'],47,'<br>');?>)</td>
  </tr>
    <?php 
    }
    ?>
