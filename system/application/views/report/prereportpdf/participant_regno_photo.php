 ...
 <table align="left" width="275" border="1" >
	...
	?>
       ...
       <?php } ?>
       		 ...
       		 <td align="center" class="style56">Kerala School Kalolsavam 2012 - 2013</td>
    </tr>
    <tr>
      ...
      <tr bgcolor="#CCCCCC">
		...
		<tr>
            ...
            <td rowspan="2" style="border-bottom:1px #000000; border-left:1px #000000; padding:0px;">
            <table>
                <tr>
                <td> 
            
            <span class="style2">&nbsp;<?php echo $partcard[0]['participant_name']; ?></span><br>
				&nbsp;<?php echo wordwrap($partcard[0]['school_code'].'  '.@$partcard[0]['school_name'],30,'<br/>');  ?><br />
    ...
    <tr>
      ...
      <tr bgcolor="#CCCCCC">
		...
		<tr>
            ...
            <tr>
            <td> 
            <span class="style2">&nbsp;<?php echo $partcard1[0]['participant_name']; ?></span><br>
				&nbsp;<?php echo wordwrap($partcard1[0]['school_code'].'  '.@$partcard1[0]['school_name'],30,'<br/>');  ?><br>
				&nbsp;<?php echo 'Class  :'.$partcard1[0]['class']."<br>&nbsp;".$partcard1[0]['sub_district_name']." - Sub-District"; ?></td>
             <td align="left" valign="top">&nbsp;&nbsp;
                 <?
				   //echo "<br /><br />-->".var_dump($Photo['pic'][$reg]);
				   $reg	=	@$partcard1[0]['admn_no'];
                    if(@$Photo['pic'][$reg])
					{
					   @$pic_path	=	@$Photo['pic'][$reg];
					   echo "<img src='".@$pic_path."'width='80' height='80'>";				 
    ...
    <tr>
      ...
      <tr bgcolor="#CCCCCC">
		...
		<tr>
            ...
            <span class="style2">&nbsp;<?php echo $partcard2[0]['participant_name']; ?></span><br>
				&nbsp;<?php echo wordwrap($partcard2[0]['school_code'].'  '.@$partcard2[0]['school_name'],30,'<br/>'); ?><br>
				&nbsp;<?php echo 'Class  :'.$partcard2[0]['class']."<br>&nbsp;".$partcard2[0]['sub_district_name']." - Sub-District"; ?></td>
                <td align="left" valign="top">&nbsp;&nbsp;
                 <?
				   //echo "<br /><br />-->".var_dump($Photo['pic'][$reg]);
				   $reg	=	@$partcard2[0]['admn_no'];
                    if(@$Photo['pic'][$reg])
					{
					   @$pic_path	=	@$Photo['pic'][$reg];
					   echo "<img src='".@$pic_path."'width='80' height='80'>";				 
