...
-->
    ...
    <tr>
    	<td align="center" class="style1" height="27" width="800">Call sheet <?php echo $fees_details[$j]['fest_name']; ?><br /><?php echo $fees_details[$j]['item_code'].' - '.$fees_details[$j]['item_name']; ?></td>
    </tr>
   </table>
	   </page_header>
       <page_footer>
...
<table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
  	<td colspan="6" style="border-bottom:1px #000000; padding:2px;">
    	...
    	<table align="center" width="100%" border="0">
        	<tr>
                <td class="style2" colspan="2" align="left" width="150">Stage No : <?php echo $fees_details[$j]['stage_name'].' - '.$fees_details[$j]['stage_desc']; ?></td>
                </tr>
                <tr>
  ...
  <?php
			 ...
			 for($i=0;$i<5;$i++)
	 {
        ...
        <table width="800" align="center" border="1">
  <tr>
    <td width="30" align="left" class="style2"  style="border-right:1px #666666; padding:2px;"height="25"></td>
    <td width="70" class="style2" align="left"  height="25" style="border-right:1px #666666; padding:2px;" > </td>
    <td width="70" class="style2" align="center"  height="25" style="border-right:1px #666666; padding:2px;" ></td>
    <td width="100" class="style2" align="center" height="25" style="border-right:1px #666666; padding:2px;">&nbsp;</td>
    <td  width="100" class="style2" align="left" height="25" style="border-right:1px #666666; padding:2px;">&nbsp;</td>
    <td width="100" class="style2" align="center" height="25" style="border-right:0px #666666; padding:2px;">&nbsp;</td>
  </tr>
