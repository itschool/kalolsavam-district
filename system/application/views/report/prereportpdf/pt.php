    	...
    	<td valign="top">
            ...
            <table border="1" width="275" >
              ...
              <tr>
                ...
                <td rowspan="2" style="border-bottom:1px #666666; border-left:1px #666666; padding:1px;"><span class="style2">
				&nbsp;
              ...
              <tr>
                <td colspan="2"  class="<?php echo $style; ?>"><table width="200">
                    <tr>
                      ...
                      <td class="style55" width="140" valign="top" align="left"><?php echo ($item['cluster_no']) ? 'CL '.$item['cluster_no'].'&nbsp;:&nbsp;' : '' ; echo $item['stage_desc'].'&nbsp; :  on  '.$dat_itme.' at '.$timer[1];?>&nbsp;</td>
                    </tr>
                </table></td>
              </tr>
              <?php
                ...
                <tr>
                    <td align="center">Reg. No</td>
                     ...
                     &nbsp;
                      ...
                      <br />
                      &nbsp;
					  <?php echo 'Class  :'.$participant_details[$i]['class']."<br>&nbsp;".$participant_details[$i]['sub_district_name']." - Sub-District"; ?>                    </td>
                </tr>
                <tr>
                    <td  width="50"class="style1" valign="top" style="border-bottom:1px #666666; border-right:0px #666666; padding:2px;" align="center"><?php echo $participant_details[$i]['participant_id']; ?></td>
                </tr>
