...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center">
    <tr>
        <td align="center" class="style1" valign="top">&nbsp;&nbsp;List of  participants &nbsp;&nbsp;</td>
    </tr>
</table>
...
<table width="100%" border="0" align="center">
 ...
 <table width="130%" border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <tr>
    ...
    <td align="center" class="ety" >&nbsp;&nbsp;<?php echo $part_details[$j]['stage_name'].' - '.$part_details[$j]['stage_desc']; //stage_desc?></td>
