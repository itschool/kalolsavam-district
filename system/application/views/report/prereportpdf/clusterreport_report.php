...
<tr>
    ...
    <td  align="left" colspan="2" class="style2" height="20">Stage: &nbsp;&nbsp;<?php echo $retdata[0]['stage_name'].' - '.$retdata[0]['stage_desc'].'   '.timetophpmodel($retdata[0]['stime']).'&nbsp;&nbsp;&nbsp; at &nbsp;&nbsp;'.$retdata[0]['ttime']; ?>&nbsp;</td>
