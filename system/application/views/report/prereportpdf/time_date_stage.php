        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
            <tr>
             ...
             <tr>
            	...
            	<td class="style1" align="center" ><?php echo @$items['item_code'].' - '.@$items['item_name'];?></td>
            </tr>
               
        </table>
        <table width="100%" border="0">
        	<tr>
            	<td align="center" width="497" class="style2">Stage :<?php echo @$items['stage_name'].' - '.$items['stage_desc'].' on   '.datetophpmodel(@$items['item_date']);?></td>
                <td align="center" width="250" class="style2">Max Time : <?php $time_type = (@$items['time_type'] == 'M') ? 'Min' : 'Sec'; echo @$items['max_time'].' '.@$time_type; ?></td>
                </tr>
