	...
	<tr>
	 ...
	 <table width="93%" align="center" border="1" cellpadding="0" cellspacing="0" >
        ...
        ?>
            ...
            <td width="208" class="style3" align="left" style="border-bottom:1px #000000; border-right:1px #000000; padding:2px;">&nbsp;&nbsp;<?php echo wordwrap($value['school_code'].' - '.$value['school_name'].'('.$value['sub_district_name'].')',50,'<br>');   ?></td>
