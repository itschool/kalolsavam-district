...
<h3>Item Wise Participants Result Details</h3>
</div>
<br />

<?php echo form_open('publishresult/Resultindex/itemwise_report', array('id' => 'itemwise','target'=>'_blank'));
echo blue_box_top();
?>
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  ...
  <tr>
    ...
    <td align="left" width="55%" class="table_row_first"><form name="form1" method="post" action="">
      <label>
      <input type="submit" name="btnSubmit" id="btnSubmit" value="View report" onClick="return checkitemwise();">
      </label>
    </form>    </td>
    <td width="18%">&nbsp;</td>
  </tr>
