<?php echo form_open('report/prereportpdf/list_participants_datewise', array('id' => 'list_participants_datewise','target'=>'_blank'));
echo blue_box_top();
?>
<input type="hidden" name="hidUserId" id="hidUserId" />
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  <tr>
    <th colspan="4" align="left">Participants List:(Date wise)</th>
  </tr>
  <tr>
