<?php echo form_open('report/prereportpdf/tabulation_date_stage', array('id' => 'clu','target'=>'_blank'));
echo blue_box_top();
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  <tr>
    <th colspan="4" align="left">Tabulation Sheet:(Date & Stage wise)</th>
  </tr>
  <tr>
  ...
  <tr>
    <td>&nbsp;</td>
     <td align="left" width="27%" class="table_row_first">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Stage : </td>
