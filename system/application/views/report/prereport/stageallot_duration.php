...
<h3>Stage Allotment Duration</h3>
</div>
<br />

<?php echo form_open('report/prereportpdf/stageallot_duration', array('id' => 'formIWP','target'=>'_blank'));
echo blue_box_top();
?>
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  <tr>
    <th colspan="4" align="left">Stage Allotment (Festival wise)</th>
  </tr>
  <tr>
