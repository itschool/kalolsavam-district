<br />
<?php echo form_open('report/prereportpdf/list_of_participants_in_group_school', array('id' => 'formP','target'=>'_blank'));
echo blue_box_top();
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  <tr>
    <th colspan="4" align="left"><strong> School Wise</strong></th>
  </tr>
  <tr>
