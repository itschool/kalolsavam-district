...
<?php echo form_open('report/prereportpdf/callsheet_report', array('id' => 'callsheet','target'=>'_blank'));
echo blue_box_top();
?>
<input type="hidden" name="hidUserId" id="hidUserId" />
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  <tr>
    <th colspan="4" align="left">Call Sheet :(Item)</th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" width="55%" class="table_row_first">      <label>
       <?php echo form_submit('Report', 'Report', 'onClick="javascript: return callsheetfirst()"');?>
        </label>
    </form>
    </td>
    <td width="18%">&nbsp;</td>
